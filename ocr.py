...
from utils import encode_image_to_base64, detect_poppler_path
...
def create_ocr_chain(model_name="gpt-4o", temperature=0.0, max_tokens=4000, api_key=None, provider="openai"):
...
def extract_answers_from_pdf(pdf_path, output_dir, app_config=None, api_key=None):
    ...
    try:
        ...
        for i, image in enumerate(images):
            ...
            extracted_text = extract_text_from_image(image_path, output_dir, app_config, api_key)
...
def process_extracted_answers(extracted_answers):
    ...
    for page, content in extracted_answers.items():
        ...
        content = re.sub(r'\[CONTINUES_FROM_PREVIOUS\]', '[CONTINUES_FROM_PREVIOUS]\n', content)
